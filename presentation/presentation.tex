...
\begin{frame}{Step 1 -- Build a model}
  ...
  \begin{itemize}
    \item Find a dataset. \textbf{Montesihno Park} contains:
      ...
      \begin{figure}
        \centering \includegraphics[width=0.5\textwidth]{park}
      \end{figure}
    \item Use supervised machine learning (linear regression) to infer the
      \textbf{probability of fire}.
\end{itemize}
\end{frame}
...
\begin{frame}{What did we do here? -- Summary}
...
\large
  ...
  \item Programmed the \textbf{patrolling algorithm} (using ROS).
  \end{itemize}
